...
--
-- Host: 127.0.0.1
-- Tempo de geração: 02/01/2025 às 15:24
...
(1, 1, 200.00, NULL, 100.00, 'concluido', '2024-12-09', '10:57:47', 300.00, 0.00, '', '1_3138159e204f95359e2f.pdf', NULL),
(2, 2, 0.00, NULL, NULL, 'pendente', NULL, NULL, 0.00, NULL, NULL, NULL, NULL),
(3, 3, 0.00, NULL, NULL, 'pendente', NULL, NULL, 0.00, NULL, NULL, NULL, NULL),
(4, 4, 0.00, NULL, NULL, 'pendente', NULL, NULL, 0.00, NULL, NULL, NULL, NULL),
(5, 5, 0.00, NULL, NULL, 'pendente', NULL, NULL, 0.00, NULL, NULL, NULL, NULL),
(6, 6, 0.00, NULL, NULL, 'pendente', NULL, NULL, 0.00, NULL, NULL, NULL, NULL);
...
(1, 1, 1, 1, '2024-12-09', '2024-12-09', '2024-12-09', '10:56:37', '2024-12-09', '10:57:47', '2024-12-09', '10:56:11', '1 dia', 'f', 200.00),
(2, 1, 1, 1, '2024-12-18', '2024-12-22', '2024-12-26', '08:30:22', NULL, NULL, '2024-12-18', '08:26:53', 'Entrada 08:30', 'i', 200.00),
(3, 4, 2, 2, '2024-12-18', '2024-12-20', '2024-12-26', '08:41:03', NULL, NULL, '2024-12-18', '09:00:42', 'entrou agora', 'i', 500.00),
(4, 2, 1, 2, '2024-12-19', '2024-12-22', '2024-12-26', '08:30:15', NULL, NULL, '2024-12-18', '09:24:41', '3123', 'i', 400.00),
(5, 4, 1, 1, '2024-12-23', '2024-12-24', '2024-12-26', '08:29:47', NULL, NULL, '2024-12-23', '10:12:06', 'sfdasdfas', 'i', 500.00),
(6, 2, 1, 2, '2024-12-26', '2024-12-26', NULL, NULL, NULL, NULL, '2024-12-26', '08:42:02', '', 'p', 400.00);
...
CREATE TABLE `reservas` (
  ...
  `status` enum('Ativa','Cancelada','Concluída') NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
--
ALTER TABLE `log`
  MODIFY `idlog` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=47;

--
-- AUTO_INCREMENT de tabela `logacesso`
--
ALTER TABLE `logacesso`
  MODIFY `idlogacesso` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=40;
...
--
-- Restrições para tabelas `adicionalconsumo`
--
ALTER TABLE `adicionalconsumo`
  ADD CONSTRAINT `adicionalconsumo_ibfk_1` FOREIGN KEY (`idconsumo`) REFERENCES `consumo` (`idconsumo`);
...
--
ALTER TABLE `consumos`
  ADD CONSTRAINT `consumos_ibfk_1` FOREIGN KEY (`id_reserva`) REFERENCES `reservas` (`id`);
...
--
ALTER TABLE `reservas`
  ADD CONSTRAINT `reservas_ibfk_1` FOREIGN KEY (`id_quarto`) REFERENCES `quartos` (`id`);
COMMIT;
